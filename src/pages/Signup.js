        ...
        <>
            <div className='container'>
                <div className='signup_container'>
                    ...
                    <form onSubmit={submitHandler} className='formStyle'>
                        ...
                        <div className='dob'>
                            ...
                            <input
                                ...
                                type='date'
                                id='dob'
                                value={formData.dob} // Ensure yyyy-MM-dd format here
                                name='dob'
                                onChange={onChangeHandler}
                            />
                            <p style={{marginLeft: '100px', marginBottom: "10px"}}>
                    ...
                    <span>Have an account?<span> <Link style={{ color: "blue", marginLeft: '5px', textDecoration: 'none' }} to='/login'>Login</Link></span></span>
                </div>
            </div>
        </>
    );
